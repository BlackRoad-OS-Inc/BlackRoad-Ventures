# TODO — BlackRoad Ventures

> Active tasks for BlackRoad Ventures
...
- [ ] [RC] Write product landing copy for: Startup Toolkit, Partner Portal, Deal Flow, Pitch Deck Builder, Cap Table Manager
